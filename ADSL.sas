...
if studyid = "CYT001-302"  then indgr1n=1;
...
format dsst01dt yymmdd10.;
merge dm7(in=a) ds1(in=b);
by usubjid;
if a;
if DSCAT="DISPOSITION EVENT" and DSSCAT="END OF STUDY" then do;
DSST01DT = input(dsstdtc,yymmdd10.); 
DSTERM1=DSTERM;
DSDECOD1=DSDECOD;end;
run;


data adsl(keep=STUDYID USUBJID SUBJID SITEID SITEGR1 SITEGR1N COUNTRY BRTHDT BRTHDTF AGE AGEU AGE1 AGEGR1 AGEGR1N SEX SEXN RACE RACEGR1 RACEGR1N 
